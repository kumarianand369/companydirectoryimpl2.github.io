    ...
    function getAllEmployeesTable() {
        $.ajax({
            ...
            success: function(result) {
                ...
                <h5 class="card-header bg-info text-white" id="addButton" data-toggle="modal" data-target="#addEmployeeModal">Employees
    ...
    function getAllDepartmentTable() {
        $.ajax({
            ...
            success: function(result) {
                ...
                <thead class="card-header bg-info text-white">
                    <tr>					
                        <th data-field="departmenttDropdown">
...
function  getAllLocationTable() {
        $.ajax({
            ...
            success: function(result) {
                ...
                <thead class="card-header bg-info text-white">
                    <tr>					
                        <th data-field="departmentDropdown">	
                        </th>
                        <th>
                            Location
                        </th>
